...
public final class TestLongView extends AbstractViewTest<Long, View<Long>> {
    public TestLongView() {
        super(() -> MoreArrays.box(AbstractTest.randomLongs(256)), a -> new ArrayLongView(MoreArrays.unbox(a)), ListView::new);
    }
}
