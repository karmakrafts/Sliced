...
public final class TestMutableByteSlice extends AbstractMutableSliceTest<Byte, MutableSlice<Byte>> {
    public TestMutableByteSlice() {
        super(() -> MoreArrays.box(randomBytes(256)), (a, o, s) -> new MutableArrayByteSlice(MoreArrays.unbox(a), o, s), MutableListSlice::new);
    }
}
