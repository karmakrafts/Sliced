...
public final class StackSliceImpl<T, S extends Stack<T>> extends AbstractSlice<T> implements StackSlice<T> {
    private final S ref;
    private int iterationIndex;

    public StackSliceImpl(final @NotNull S ref, final int offset, final int size) {
        super(offset, size);
        this.ref = ref;
    }
    ...
    public @NotNull Slice<T> slice(final int offset, final int size) {
        return new StackSliceImpl<>(ref, this.offset + offset, size);
    }
    ...
    public boolean equals(final @Nullable Object obj) {
        if (obj instanceof StackSliceImpl) {
            final StackSliceImpl<?, ?> other = (StackSliceImpl<?, ?>) obj;
