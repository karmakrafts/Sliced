...
public final class ArrayCharSliceImpl extends AbstractSlice<Character> implements CharSlice {
    private final char[] ref;
    private int iterationIndex;

    public ArrayCharSliceImpl(final char[] ref, final int start, final int end) {
        super(start, end);
        this.ref = ref;
    }
