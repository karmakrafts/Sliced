...
public final class TestMutableFloatSlice extends AbstractMutableSliceTest<Float, MutableSlice<Float>> {
    public TestMutableFloatSlice() {
        super(() -> MoreArrays.box(randomFloats(256)), (a, o, s) -> new MutableArrayFloatSlice(MoreArrays.unbox(a), o, s), MutableListSlice::new);
    }
}
