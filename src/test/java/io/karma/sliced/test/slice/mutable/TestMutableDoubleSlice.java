...
public final class TestMutableDoubleSlice extends AbstractMutableSliceTest<Double, MutableSlice<Double>> {
    public TestMutableDoubleSlice() {
        super(() -> MoreArrays.box(randomDoubles(256)), (a, o, s) -> new MutableArrayDoubleSlice(MoreArrays.unbox(a), o, s), MutableListSlice::new);
    }
}
