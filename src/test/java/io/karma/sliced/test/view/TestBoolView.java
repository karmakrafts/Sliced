...
public final class TestBoolView extends AbstractViewTest<Boolean, View<Boolean>> {
    public TestBoolView() {
        super(() -> MoreArrays.box(AbstractTest.randomBools(256)), a -> new ArrayBoolView(MoreArrays.unbox(a)), ListView::new);
    }
}
