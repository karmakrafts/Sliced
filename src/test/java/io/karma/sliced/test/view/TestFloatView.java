...
public final class TestFloatView extends AbstractViewTest<Float, View<Float>> {
    public TestFloatView() {
        super(() -> MoreArrays.box(AbstractTest.randomFloats(256)), a -> new ArrayFloatView(MoreArrays.unbox(a)), ListView::new);
    }
}
