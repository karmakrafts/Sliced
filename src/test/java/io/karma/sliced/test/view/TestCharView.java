...
public final class TestCharView extends AbstractViewTest<Character, View<Character>> {
    public TestCharView() {
        super(() -> MoreArrays.box(AbstractTest.randomChars(256)), a -> new ArrayCharView(MoreArrays.unbox(a)), ListView::new);
    }
}
