...
final class StringCharSliceImpl extends AbstractSlice<Character> implements CharSlice {
    private final CharSequence ref;
    private int iterationIndex = 0;

    StringCharSliceImpl(final @NotNull CharSequence ref, final int start, final int end) {
        super(start, end);
        this.ref = ref;
    }
    ...
    public boolean equals(final @Nullable Object obj) {
        final boolean isArray = obj instanceof char[];
