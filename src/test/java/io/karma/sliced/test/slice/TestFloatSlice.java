...
public final class TestFloatSlice extends AbstractSliceTest<Float, Slice<Float>> {
    public TestFloatSlice() {
        super(() -> MoreArrays.box(randomFloats(256)), (a, o, s) -> new ArrayFloatSlice(MoreArrays.unbox(a), o, s), ListSlice::new);
    }
}
