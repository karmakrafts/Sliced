...
public interface MutableBoolSlice extends MutableSlice<Boolean>, BoolSlice {
     ...
     */
    static @NotNull MutableBoolSlice of(final boolean[] ref, final int offset, final int size) {
        return new MutableArrayBoolSlice(ref, offset, size);
    }
    ...
    static @NotNull MutableBoolSlice of(final boolean... ref) {
        return new MutableArrayBoolSlice(ref, 0, ref.length);
    }
}
