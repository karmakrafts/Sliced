...
public final class TestIntView extends AbstractViewTest<Integer, View<Integer>> {
    public TestIntView() {
        super(() -> MoreArrays.box(AbstractTest.randomInts(256)), a -> new ArrayIntView(MoreArrays.unbox(a)), ListView::new);
    }
}
