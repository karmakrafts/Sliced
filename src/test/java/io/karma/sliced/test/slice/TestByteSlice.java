...
public final class TestByteSlice extends AbstractSliceTest<Byte, Slice<Byte>> {
    public TestByteSlice() {
        super(() -> MoreArrays.box(AbstractTest.randomBytes(256)), (a, o, s) -> new ArrayByteSlice(MoreArrays.unbox(a), o, s), ListSlice::new);
    }
}
