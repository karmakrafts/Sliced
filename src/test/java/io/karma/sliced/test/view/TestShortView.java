...
public final class TestShortView extends AbstractViewTest<Short, View<Short>> {
    public TestShortView() {
        super(() -> MoreArrays.box(AbstractTest.randomShorts(256)), a -> new ArrayShortView(MoreArrays.unbox(a)), ListView::new);
    }
}
