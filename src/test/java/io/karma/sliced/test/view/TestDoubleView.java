...
public final class TestDoubleView extends AbstractViewTest<Double, View<Double>> {
    public TestDoubleView() {
        super(() -> MoreArrays.box(AbstractTest.randomDoubles(256)), a -> new ArrayDoubleView(MoreArrays.unbox(a)), ListView::new);
    }
}
