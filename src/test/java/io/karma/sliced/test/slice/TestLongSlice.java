...
public final class TestLongSlice extends AbstractSliceTest<Long, Slice<Long>> {
    public TestLongSlice() {
        super(() -> MoreArrays.box(randomLongs(256)), (a, o, s) -> new ArrayLongSlice(MoreArrays.unbox(a), o, s), ListSlice::new);
    }
}
