...
public final class TestIntSlice extends AbstractSliceTest<Integer, Slice<Integer>> {
    public TestIntSlice() {
        super(() -> MoreArrays.box(AbstractTest.randomInts(256)), (a, o, s) -> new ArrayIntSlice(MoreArrays.unbox(a), o, s), ListSlice::new);
    }
}
